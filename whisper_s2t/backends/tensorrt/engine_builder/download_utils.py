...
_MODELS = {
    ...
    "large-v3-turbo": "https://openaipublic.azureedge.net/main/whisper/models/e5b1a55b89c1367dacf97e3e19bfd829a01529dbfdeefa8caeb59b3f1b81dadb/large-v3.pt",
}
...
_TOKENIZER = {
    ...
    "large-v3-turbo": "https://huggingface.co/ylacombe/whisper-large-v3-turbo/resolve/main/tokenizer.json",
}
...
def download_model(name):
    ...
    if os.path.exists(model_ckpt_path) and not os.path.isfile(model_ckpt_path):
        raise RuntimeError(f"{model_ckpt_path} exists and is not a regular file")  # noqa
