...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        help=(
            "Activates attention plugin. You can specify the plugin dtype or leave"
            " blank to use the model dtype."
        ),
    )
    parser.add_argument(
        ...
        choices=["float16", "float32", "bfloat16"],
        help=(
            "Activates BERT attention plugin. You can specify the plugin dtype or leave"
            " blank to use the model dtype."
        ),
    )
    parser.add_argument(
        ...
        choices=["float16", "float32", "bfloat16"],
        help=(
            "Activates GEMM plugin. You can specify the plugin dtype or leave blank to"
            " use the model dtype."
        ),
    )
    ...
    parser.add_argument(
        ...
        help=(
            "The path to save the serialized engine files, timing cache file and model"
            " configs"
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "By default, we use dtype for KV cache. int8_kv_cache chooses int8"
            " quantization for KV"
        ),
    )
